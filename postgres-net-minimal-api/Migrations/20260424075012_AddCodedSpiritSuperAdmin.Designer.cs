...
namespace postgres_net_minimal_api.Migrations
{
    ...
    [Migration("20260424075012_AddCodedSpiritSuperAdmin")]
    partial class AddCodedSpiritSuperAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.PostTag", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Roles.Models.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Users.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Super",
                            HashedPassword = "$2a$12$AIyvBPaFAwg.HVFlbCXTMugw8A4hU6LKlJCCbqxMiFvobB3eu0JYW",
                        ...
                        new
                        {
                            ...
                            FirstName = "Coded",
                            HashedPassword = "$2a$11$dae4NmZDBgaxCPjLIhX.u.apR40SCBsd9sm0PCvNdmcu4JdKldbTG",
                            LastName = "Spirit",
                            RoleId = new Guid("10000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Authorization.Models.RolePermission", b =>
                {
                    ...
                    b.HasOne("postgres_net_minimal_api.Roles.Models.UserRole", "Role")
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Comment", b =>
                {
                    b.HasOne("postgres_net_minimal_api.Users.Models.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("postgres_net_minimal_api.Blog.Models.Comment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("postgres_net_minimal_api.Blog.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Post", b =>
                {
                    ...
                    b.HasOne("postgres_net_minimal_api.Blog.Models.Category", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("postgres_net_minimal_api.Blog.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("postgres_net_minimal_api.Blog.Models.Profile", b =>
                {
                    b.HasOne("postgres_net_minimal_api.Users.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("postgres_net_minimal_api.Blog.Models.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
